  ...
  test("builds CLI commands from schema + values", () => {
    const cases: Array<{
      ...
      },
      {
        ...
        values: { name: "John" },
        expected: "myapp greet --name John",
      },
      {
        ...
        expected: "myapp greet --name \"John Doe\"",
      },
      {
      ...
      },
      {
        ...
        values: { count: 42 },
        expected: "myapp process --count 42",
      },
      {
        name: "array values",
        commandPath: ["process"],
        ...
        expected: "myapp process --files a.txt --files b.txt",
      },
      {
        ...
        values: { force: true },
        expected: "myapp db migrate --force",
      },
      {
        ...
        expected: "myapp build --output-dir /tmp --max-retries 3",
      },
      {
